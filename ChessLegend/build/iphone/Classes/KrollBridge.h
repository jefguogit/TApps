...
@interface ChessLegendObject : KrollCoverageObject {
#else
@interface ChessLegendObject : KrollObject {
#endif
@private
...
extern NSString * ChessLegend$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	ChessLegendObject *_chesslegend;
    KrollObject* console;
	BOOL shutdown;
