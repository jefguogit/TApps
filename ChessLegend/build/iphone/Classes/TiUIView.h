...
/**
 Base class for all ChessLegend views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the ChessLegend view hierarchy (such as wrapped iOS UIViews) was touched.
