...
//@interface ChessLegendObject : NSObject
//@end

@interface ChessLegendObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ChessLegendObject class]])
		{
			for (NSString *key in [[(ChessLegendObject*)o modules] allKeys])
			{
