...
// in simulator we redefine to format for ChessLegend Developer console
...
{\
	NSString * exceptionName = [@"org.chesslegend." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.chesslegend";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIChessLegendNativeItemNone = -1, 
	UIChessLegendNativeItemSpinner = -2,
	UIChessLegendNativeItemProgressBar = -3,
	
	UIChessLegendNativeItemSlider = -4,
	UIChessLegendNativeItemSwitch = -5,
	UIChessLegendNativeItemMultiButton = -6,
	UIChessLegendNativeItemSegmented = -7,
	
	UIChessLegendNativeItemTextView = -8,
	UIChessLegendNativeItemTextField = -9,
	UIChessLegendNativeItemSearchBar = -10,
	
	UIChessLegendNativeItemPicker = -11,
	UIChessLegendNativeItemDatePicker = -12,
	
	UIChessLegendNativeItemInfoLight = -13,
	UIChessLegendNativeItemInfoDark = -14,
	
	UIChessLegendNativeItemDisclosure = -15,
	
	UIChessLegendNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ChessLegend instances of
