...
//Rare exceptions to indicate a bug in the _appceleratorapi code (Eg, function that a subclass should have implemented)
...
/**
 The base class for AppceleratorAPIAPI proxies.
 */
