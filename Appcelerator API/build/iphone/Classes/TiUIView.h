...
/**
 Base class for all AppceleratorAPIAPI views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the AppceleratorAPIAPI view hierarchy (such as wrapped iOS UIViews) was touched.
