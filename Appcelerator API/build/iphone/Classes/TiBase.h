...
// in simulator we redefine to format for AppceleratorAPIAPI Developer console
...
{\
	NSString * exceptionName = [@"org.appceleratorapi." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.appceleratorapi";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIAppceleratorAPIAPINativeItemNone = -1, 
	UIAppceleratorAPIAPINativeItemSpinner = -2,
	UIAppceleratorAPIAPINativeItemProgressBar = -3,
	
	UIAppceleratorAPIAPINativeItemSlider = -4,
	UIAppceleratorAPIAPINativeItemSwitch = -5,
	UIAppceleratorAPIAPINativeItemMultiButton = -6,
	UIAppceleratorAPIAPINativeItemSegmented = -7,
	
	UIAppceleratorAPIAPINativeItemTextView = -8,
	UIAppceleratorAPIAPINativeItemTextField = -9,
	UIAppceleratorAPIAPINativeItemSearchBar = -10,
	
	UIAppceleratorAPIAPINativeItemPicker = -11,
	UIAppceleratorAPIAPINativeItemDatePicker = -12,
	
	UIAppceleratorAPIAPINativeItemInfoLight = -13,
	UIAppceleratorAPIAPINativeItemInfoDark = -14,
	
	UIAppceleratorAPIAPINativeItemDisclosure = -15,
	
	UIAppceleratorAPIAPINativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all AppceleratorAPIAPI instances of
