 ...
 * Copyright (c) 2009-2011 by AppceleratorAPI, Inc. All Rights Reserved.
...
//@interface AppceleratorAPIAPIObject : NSObject
//@end

@interface AppceleratorAPIAPIObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AppceleratorAPIAPIObject class]])
		{
			for (NSString *key in [[(AppceleratorAPIAPIObject*)o modules] allKeys])
			{
