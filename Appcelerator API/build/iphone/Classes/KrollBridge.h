...
@interface AppceleratorAPIAPIObject : KrollCoverageObject {
#else
@interface AppceleratorAPIAPIObject : KrollObject {
#endif
@private
...
extern NSString * AppceleratorAPIAPI$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	AppceleratorAPIAPIObject *_appceleratorapi;
    KrollObject* console;
	BOOL shutdown;
