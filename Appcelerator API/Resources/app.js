...
Ti.API.info("r:"+Ti.Filesystem.resourcesDirectory);
Ti.API.info("a:"+Ti.Filesystem.applicationDataDirectory);
Ti.API.info("t:"+Ti.Filesystem.applicationSupportDirectory);
Ti.API.info("aa:"+Ti.Filesystem.applicationDirectory);		
