...
function MasterView() {
	...
	var self = Ti.UI.createView({
		...
		backgroundImage:Ti.Filesystem.resourcesDirectory+'images/master_body.png',
		borderWidth:3
//		borderColor:'transparent'
	...
	var table1 = Ti.UI.createTableView({
		...
		left:2,
		top:53,
		width:myChess.width-10,
		height:myChess.height-60,
		rowHeight:30,
...
if((no+1)!=game.Gid%10000){
	Ti.API.info(no+"/"+game.Gid);
}
...
function getInitData(){
	...
	tdata[1].title=" ... Loading game list ...";
