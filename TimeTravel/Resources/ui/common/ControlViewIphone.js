...
//Ti.API.log("control view :"+width+"  "+height);
	...
	var ConstantClass = require('ui/common/object/Constant');
...
//	Ti.API.info('end control:'+self);
	...
	var valueLabel = Titanium.UI.createLabel({
		text:Math.round(myChess.chessObj.playingSpeed/1000)+' s' ,
		color:'#000',
		font:{
			fontFamily:'Helvetica Neue',
			fontSize:10
...
//		highlightedThumbImage:'../images/chat.png'
	...
	basicSlider.addEventListener('change',function(e)
	{
		...
		valueLabel.text = Math.round(myChess.chessObj.playingSpeed/1000)+' s';		
	});
	// For #806
