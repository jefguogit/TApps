...
//		backgroundImage: Titanium.Filesystem.resourcesDirectory + '/image/leftpan.png',
	...
	var titlebar = Ti.UI.createImageView({
		image: Titanium.Filesystem.resourcesDirectory + '/image/titlebar_module.png',
		height:40,
		top:0,
		left:0
	});
...
//		title:'MODULE'
	...
	moduleButton.addEventListener('click',function(){
		...
		titlebar.image = Titanium.Filesystem.resourcesDirectory + '/image/titlebar_module.png';
		search.height = 38;
		search.top=5;
		search.backgroundImage = Titanium.Filesystem.resourcesDirectory + '/image/navbar_background.png';
	});
...
//		title:'OBJECT'
	...
	objectButton.addEventListener('click',function(){
		...
		titlebar.image = Titanium.Filesystem.resourcesDirectory + '/image/titlebar_object.png';
		search.height = 36;
		search.top=5;
		search.backgroundImage = Titanium.Filesystem.resourcesDirectory + '/image/navbar_background.png';
...
//		barColor:'#771111',
		backgroundImage:Titanium.Filesystem.resourcesDirectory + 'navbar_background.png',
		showCancel:false,
		height:36,
		top:5,
		left:175
...
//		Titanium.UI.createAlertDialog({title:'Search Bar', message:'You typed ' + e.value }).show();
		...
		titlebar.image = Titanium.Filesystem.resourcesDirectory + '/image/titlebar_search.png';
		search.height = 33;
		search.top=8;
		search.backgroundImage = Titanium.Filesystem.resourcesDirectory + '/image/navbar_background_w.png';
	});
...
//		backgroundImage:Ti.Filesystem.resourcesDirectory+'image/tablerowb.png',
	...
	if(item.type=="module"){
		icon.image = Titanium.Filesystem.resourcesDirectory + '/image/moduleicon.png';
	}else{
		icon.image = Titanium.Filesystem.resourcesDirectory + '/image/objecticon.png';
	}
